...
public class BasicSolver implements Solver {
    ...
    public void init(Function function, OptimizationMethod /*QuasiNewtonMethod*/ method) throws Exception {
   ...
   // TODO: zobecnit xValue, yValue
    public void init(Function function, QuasiNewtonMethod2 method, double[] xValue, double yValue) throws Exception {
        this.function = function;
        this.method = method;
        ...
        method.init(baseObjectiveFunction, xValue, yValue);
    ...
    public double[] getResultX() {
      ValuePoint p = (ValuePoint) method.getValue().getValue();
      return p.getPoint().toArray();
    }
