...
/*    @Property
    ...
    private CentralDifferenceGradient grad = new CentralDifferenceGradient();
    private BaseObjectiveFunction objFunc = new BaseObjectiveFunction(this);
...
*/
    public double valueAt(Point point) {
      double[] x;
      x = point.toArray();
      return 3*x[0]*x[0]+3;     // ne pro linearni funkce
...
/*
    ...
    public Gradient gradientAt(Point point) {
      ...
      return grad.gradientAt(objFunc, point);
    }
